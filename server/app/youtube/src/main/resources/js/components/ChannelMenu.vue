<template>
<div v-if="channel" class="channel-menu">
    <div>
        <div class="subtitle-1">{{channel.name}}</div>
        <div class="caption"></div>
    </div>
    <div>
        <div v-for="scrollMenuItem in scrollMenuItems" :key="scrollMenuItem.title" :class="scrollMenuItemClass(scrollMenuItem)" class="pa-3 scroll-menu-item">
